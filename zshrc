...
plugins=(ansible tmux ssh-agent zsh-autosuggestions zsh-syntax-highlighting kubectl helm)

source $ZSH/oh-my-zsh.sh

# User configuration

export PATH="/home/brian/bin:/home/brian/env/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
...
PATH="/home/brian/perl5/bin${PATH:+:${PATH}}:/snap/bin"; export PATH;
...
PATH="/usr/local/go/bin${PATH:+:${PATH}}"; export PATH;
setopt correct
